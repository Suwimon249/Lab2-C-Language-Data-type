...
1.1  ทำไม 10 / 3.0 (เมื่อตัวหารเป็น float หรือ double) ถึงได้ผลลัพธ์เป็นทศนิยม แต่เมื่อตัวหารถูกแปลงเป็น int แล้วผลลัพธ์เป็นจำนวนเต็ม? <br>
 เพราะชนิดข้อมูลมีผลต่อวิธีคำนวณ ถ้าหนึ่งในตัวแปรเป็น float หรือ double การหารจะให้ผลลัพธ์แบบทศนิยม แต่ถ้าทั้งคู่เป็น int ผลลัพธ์จะถูกปัดเศษทิ้ง
...
- ในการเขียนโปรแกรม ต้องทำ Type Casting ในสถานการณ์ใดบ้าง <br>
 เพื่อป้องกันความผิดพลาดในการคำนวณ,แสดงค่าหรือเปรียบเทียบตัวแปรต่างชนิด
