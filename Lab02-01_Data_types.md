...
2.1  สังเกตผลจากการรันโคิดในส่วน 2.1 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด <br>
ตรงตามหลักคณิตศาสตร์

2.2  สังเกตผลจากการรันโคิดในส่วน 2.2 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด <br>
ตรงตามหลักคณิตศาสตร์ เพราะยังไม่เกิด overflow

2.3  สังเกตผลจากการรันโคิดในส่วน 2.3 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด <br>
ไม่ตรงกับหลักคณิตศาสตร์ ควรได้ 2147483648

2.4  สังเกตผลจากการรันโคิดในส่วน 2.4 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด <br>
ตรงตามหลักคณิตศาสตร์

2.5  สังเกตผลจากการรันโคิดในส่วน 2.5 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด <br>
ไม่ตรงกับหลักคณิตศาสตร์ ควรได้ -2147483649
...
3.1 คุณสังเกตเห็นความแตกต่างของความแม่นยำระหว่าง float และ double อย่างไร? <br>
float แสดงค่าได้ประมาณ 6-7 หลักทศนิยมเท่านั้น ถึงจะพิมพ์ 8 หลัก แต่หลังหลักที่ 6 หรือ 7 จะเริ่มมีความเคลื่อน <br>
double สามารถเก็บค่าได้แม่นยำกว่า และแสดงได้ประมาณ 15-16 หลักทศนิยม
3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float? <br>
เมื่อต้องการความแม่นยำสูงในการคำนวณและค่าตัวเลขมีความละเอียด
...
4.1 ค่าตัวเลข (ASCII value) มีความสัมพันธ์กับอักขระอย่างไร? <br>
คือ รหัสตัวเลขที่ใช้แทนตัวอักขระในคอมพิวเตอร์
4.2 ถ้าอยากทราบความสัมพันธ์ระหว่างตัวเลขกับอักขระทั้งหมด สามารถหาได้จากเอกสารใด หรือแหล่งอ้างอิงใด <br>
ASCII Table (official) <br>
Wikipedia: ASCII
4.3 จากข้อ 4.2 นักเขียนโปรแกรมสามารถกำหนดขึ้นเองได้ หรือมีเอกสารใดกำกับอยู่ <br>
ไม่สามารถกำหนดเองได้ เพราะมีมาตรฐาน ANSI / ISO กำกับอยู่แล้ว
...
5.1 true และ false ถูกแสดงผลเป็นค่าใดบน Serial Monitor? <br>
true=ผลลัพธ์: 1 <br>
false=ผลลัพธ์: 0
...
6.1 บน ESP32, long มีขอบเขตเท่ากับ int หรือไม่? <br>
int และ long คือชนิดเดียวกัน long myLong = 4000000000L; จะเกิด overflow

6.2 ชนิดข้อมูลใดที่ต้องใช้หากต้องการเก็บค่าจำนวนเต็มบวกที่ใหญ่ที่สุด? <br>
...
- เมื่อ myByte ถูกกำหนดให้เป็น 256 ผลลัพธ์ที่ได้คืออะไร และเพราะเหตุใด? <br>
ค่าที่เกินจาก 255 จะoverflow โดยตัดเอาแค่ 8 บิตล่างสุด
